...
1. **旧端末（iPhone 11）**  
   1) LINE を最新バージョンへ更新  
   2) `ホームタブ › 設定 › トークのバックアップ › 今すぐバックアップ`  
2. **新端末（iPhone 16 など）**  
   1) 同じ Apple ID で iCloud にサインイン  
   2) LINE 初回起動 → 電話番号ログイン → 「バックアップから復元」を選択  
3. 復元後、スタンプ・テーマを再ダウンロードして完了  
...
| Q | A |
|---|---|
| **iPhone 11 が iOS 18 に上げられなくても大丈夫？** | はい。iOS 14–17 でもバックアップ／復元は問題なく動作します。 |
| **iCloud 容量が足りないときは？** | PC/Mac の iTunes (Finder) で暗号化フルバックアップを取り、初期セットアップ時に復元する方法もあります。 |
| **電話番号が変わる場合は？** | 旧端末で事前に「電話番号変更」手続き → 新番号確認を済ませておくとスムーズです。 |

これで「iPhone 11 から新 iPhone への LINE トーク履歴完全移行」が可能だとご確認いただけたかと思います！　ほかに気になる点（iCloud 容量の節約策、同時に行うアプリ引き継ぎのコツなど）があればいつでもどうぞ。
...
| iPhone 16 Pro | 159,800 円 | A18 Pro | 8 GB | **3450 / 8502** | 6.3" OLED | 1‑120 Hz | 4,685 mAh | 35 W | 48 MP + 48 MP UW + 12 MP 5× | Apple Pay | 5–7 年想定 | 203 g |
...
| Galaxy S25 Ultra | 199,800 円 (256 GB) | Snapdragon 8 Elite | 12 GB | **3069 / 9080** | 6.9" AMOLED | 1‑120 Hz | 5,000 mAh | 45 W | 200 MP + 50/48/12 MP | ○ | 7 年保証 | 232 g |
...
| Xperia 1 VI | 179,300 円 | Snapdragon 8 Gen 3 | 12 GB | **2131 / 6292** | 6.5" LTPO OLED | 1‑120 Hz | 5,000 mAh | 30 W | 48 MP + 12 MP UW + 12 MP 85‑170 mm | ○ | 3 世代 | 192 g |
